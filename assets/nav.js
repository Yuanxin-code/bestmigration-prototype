...
window.PLUGGABLE_APPS = [
  ...
  {
    id: 'store-migration', name: '店铺搬迁', icon: 'migration', builtin: true, category: 'Store management', status: 'available',
    tagline: 'Move your store data to BestShopio.',
    blurb: 'Authorize a source store, select the data you need, and track every migration task without leaving the merchant admin.',
    menu: { id: 'store-migration', label: '店铺搬迁', icon: 'migration', route: '#/store-migration', desc: 'Move source-store data and review migration results.' },
  },
...
window.ROUTE_MODULE = {
  ...
  apps: 'apps', subscriptions: 'subscriptions', bundles: 'bundles', 'store-migration': 'store-migration',
};
