...
(function () {
  var V = '20260728emailnotifications100senderdisabled1'; // cache-bust for lazy-loaded module scripts
  ...
  var ICONS = {
    ...
    migration: s('<path d="M4 7h12"/><path d="m12 3 4 4-4 4"/><path d="M20 17H8"/><path d="m12 13-4 4 4 4"/>'),
  };
  window.ICONS = ICONS;
